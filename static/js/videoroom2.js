...
var server = "http://" + getCookie('IP') + ":8088/janus";
...
var c = document.getElementById("body_pix");
var v = document.getElementById("videopix");
						...
						janus.attach(
							{
								...
								onlocalstream: function(stream) {
									...
									Janus.attachMediaStream($('#myvideo').get(0), s);
									...
									var videoTracks = s.getVideoTracks();
